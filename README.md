...
| DƯƠNG THỊ NGÂN | 2A202602808 | UX & validation | Luồng trải nghiệm, responsive, liên hệ Trang, tổ chức usability test trực tiếp và ghi quote/evidence |
| VŨ HUY ĐÔ | 2A202602555 | Evidence, form & demo | Mining evidence, golden set cơ bản, liên hệ Thái và Cương, tạo form willing-user, tổng hợp phản hồi, video CP3, slide và demo dự phòng |
|  |  |  |  |
